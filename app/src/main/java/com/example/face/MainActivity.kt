...
import com.example.face.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    var cameraPorvider : ProcessCameraProvider? = null
    ...
    fun setUpCamera(){
        ...
        cameraProviderFuture.addListener(Runnable {
            ...
            cameraPorvider = cameraProviderFuture.get()
            bindCameraUseCases()
    ...
    fun bindCameraUseCases(){
        ...
        cameraPorvider?.unbindAll()

        try{
            camera = cameraPorvider?.bindToLifecycle(this,cameraSelector,preview,imageCapture,imageAnalysis)
        ...
        override fun analyze(image: ImageProxy) {
            ...
            FirebaseVision.getInstance()
                ...
                .addOnSuccessListener { faces ->
                    ...
                    for(face in faces){
                        var faceGraphic = FaceGraphic(graphicOverlay,face,BitmapFactory.decodeResource(resources,
                            R.drawable.lens))
